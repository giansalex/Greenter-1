...
public class Item {
    ...
    public static ArrayList<Item> getTestingList() {
        ...
        items.add(new Item("$12", "$350", "56th Ave, NY, 10041", "W 36th St, NY, 10043", 0, "TODAY", "01:15 PM"));
        items.add(new Item("$65", "$400", "56th Ave, NY, 10041", "W 36th St, NY, 10011", 0, "TODAY", "08:15 PM"));
        return items;
